...
namespace ComputerPeripheralsShopModel.ViewModels.MenuPagesViewModels
{
    ...
    {
        private ObservableCollection<Product> _keyboards;
        public ObservableCollection<Product> Keyboards { get => this._keyboards; set => this._keyboards = value; }
        ...
        public KeyboardsViewModel()
        {
            ...
            {
                Keyboards = unitOfWork.ProductRepository.getKeyboards();
            }
